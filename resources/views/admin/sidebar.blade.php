    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  ...
                  @if($user->email == 'yasmeen@gmail.com')
              ...
              <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown">
                ...
                <a href="{{Route('profile.show')}}" class="dropdown-item preview-item">
                  ...
                  <div class="preview-item-content">
                    <p class="preview-subject ellipsis mb-1 text-small">Change profile image</p>
                  </div>
                </a>
              </div>
            </div>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href={{'/showCategories'}}>
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{'/showCourses'}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
              <span class="menu-title">Coursies</span>
            </a>
          </li>
          
          <li class="nav-item menu-items">
            <a class="nav-link" href={{'/showInstructors'}}>
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{'/showAdmins'}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{'/showMembers'}}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
